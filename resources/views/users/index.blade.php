...
<a href="{{ route('users.create') }}" class="btn btn-outline-primary mt-2 mb-3"><i class="bi bi-file-earmark-plus-fill"></i> Crear</a>
     ...
     <tbody>
        @foreach ($users as $user )
         ...
         <td>
                 ...
                 @csrf
                 @method('DELETE')
                <a href="{{ route('users.edit',$user->id)}}" class="btn btn-outline-primary d m-0 "><i class="bi bi-pencil-square"></i> Editar</a>
